...
const handleLeftclose = () => {
  ...
  return (
    <div className="main h-screen flex container mx-auto overflow-y-auto bg-gradient-to-t from-yellow-300 to-blue-500 duration-300 relative">
      ...
      {left ? (<>
        <div className="flex items-center justify-center cursor-pointer lg:hidden block" onClick={handleLeftclose}><IoCloseSharp className="text-2xl cursor-pointer absolute top-8 left-36 " /></div>
        <div className="left w-48 h-screen lg:bg-slate-300 p-5 lg:hidden block duration-300">
        <img
      ...
      <div className="right p-4 w-full h-screen duration-300">
        <div className="nav flex items-center justify-between w-full p-2 ">
            {menu ? (<>
                <div className="flex items-center justify-center cursor-pointer lg:hidden block" onClick={handleLeftElm}><IoMenuSharp className="text-2xl"/></div>
            </>) : (<></>)}
        ...
        {loader ? (<><div className="text-center text-4xl mt-10 font-bold font-serif ">Loading...</div></>) : (<>
            ...
            return (
              <>
                <div
                  ...
                  key={elm.createrId}
                >
                  <img src={elm.image.url} alt="" className="lg:w-64 object-contain w-full" />
                  <div className="mt-2">
                    ...
                    <Link to={"/buy/" + elm._id} className="w-full text-center p-2 mt-2 bg-orange-500 text-white rounded-md text-lg font-bold cursor-pointer hover:bg-orange-400 duration-300">Buy Now</Link>
                  </div>
                </div>
              </>
            );
